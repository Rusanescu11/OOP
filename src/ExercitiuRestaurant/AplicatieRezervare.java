...
public class AplicatieRezervare {
    List<Restaurant> listaRestaurante = new ArrayList<>();
    public AplicatieRezervare() {
    ...
    private void cautaRezervariRestaurant() {                    //METODA
        Scanner input=new Scanner(System.in);
    ...
    private void arataRezervariRestaurantDupaNume(String numePersoanaCareRezerv,String numeRestaurant){  //METODA
        for (Restaurant n:listaRestaurante){
            if (numeRestaurant.equals(n.getNume())){
    ...
    private boolean cautaRezervariRestaurantDupaNume(String numePersoanaCareRezerv){    //METODA
        for (Restaurant n:listaRestaurante){
