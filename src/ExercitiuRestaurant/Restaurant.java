...
public class Restaurant {
    ...
    public void sorteazaMeseleDupaNumarulDeLocuri() {                    //METODA
        ListaTipuriDeMese.sort(Comparator.comparing(Masa::getNumarLocuri));
    }

    public void adaugaInListaTipuriDeMese(int numarLocuri, String nume) { //METODA
        Masa masa = new Masa(numarLocuri, nume);
        ListaTipuriDeMese.add(masa);
    }

    public void arateListaMesePentruRezervat() {                          //METODA
    ...
    public void arataRezervariRestaurant() {                         //METODA
        for (Masa n : ListaTipuriDeMese) {
            n.afiseazaRezervariMese();
        }
    }

    public void arataRezervariRestaurantDupaNume(String numePersoanaCareRezerv) {   //METODA
        for (Masa n : ListaTipuriDeMese) {
    ...
    public boolean cautaRezervareRestaurantDupaNume(String numePersoanaCareRezerv) {   //METODA
        for (Masa n : ListaTipuriDeMese) {
            if (n.cautaRezervareDupaNume(numePersoanaCareRezerv)) {
                return true;
            }
